/**
 * Prisma Client Mock — Auto-resolved by Jest
 * 
 * Jest resolves this file automatically when `jest.mock('@/lib/db')` is called,
 * because this __mocks__/db.ts is adjacent to the real db.ts.
 * 
